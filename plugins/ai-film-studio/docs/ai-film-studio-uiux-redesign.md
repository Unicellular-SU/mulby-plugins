...
| 1 | 组件库 P0 · 余下：IconButton / 自定义 Select+Combobox（headless 弹层）/ Switch / Segmented / Tabs / Field 容器 | ⏳ 待办 | 自定义 Select/Combobox/Switch 需引入 headless 行为库（Radix / React Aria）或手写 listbox，属较重改造，单列。 |
