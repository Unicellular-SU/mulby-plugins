...
import { Crop, Maximize2, Sparkles, Scissors, Grid2x2, Film, Images, Clapperboard, Music, VolumeX, Rewind, Minimize2, Brush, Download, Wand2, Compass, GitMerge, Boxes, Crosshair, ArrowUpDown } from 'lucide-react'
...
import { selfCheckProjection, progressiveEquirect, repairEquirectPoles } from '../services/panoOutpaint'
    ...
    <div className="flex items-center gap-0.5 overflow-x-auto ace-noscroll">
      {isImg && (
        <>
          ...
          {(card.meta as any)?.pano && <IconBtn icon={Crosshair} title="投影自检" onClick={() => void selfCheckProjection(card.id)} />}
