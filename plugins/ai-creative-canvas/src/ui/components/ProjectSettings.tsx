...
export function ProjectSettings() {
  ...
  useEffect(() => {
    ...
    const onDown = (e: PointerEvent) => {
      ...
      if (t.closest?.('[data-interactive]')) return // 自定义 Select 浮层渲染在 body 上
      setOpen(false)
    }
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          className="absolute right-0 top-full mt-1 z-50 w-64 rounded-lg border bg-white dark:bg-neutral-900 shadow-xl p-3 flex flex-col gap-3 text-sm text-neutral-800 dark:text-neutral-200"
